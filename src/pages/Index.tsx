          ...
          <div className="relative z-10 pb-12 px-4">
            <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6">
              {stats.map((stat, index) => (
                <div key={index} className="bg-white/10 backdrop-blur-md rounded-lg p-6 text-center border border-white/20">
                  <div className="font-bold text-2xl md:text-3xl mb-2" style={{ color: '#EEBC06' }}>
                    {stat.value}
                  </div>
