...
import PropertyTypesVariants from "./pages/PropertyTypesVariants";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/variants" element={<AboutVariants />} />
          ...
          <Route path="/property-types-variants" element={<PropertyTypesVariants />} />
